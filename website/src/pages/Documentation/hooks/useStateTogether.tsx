...
const description =
  'The useStateTogether hook makes every user see the same state simultaneously. ' +
  'If the user is not connected to any session, then this hook behaves as a normal useState.'
