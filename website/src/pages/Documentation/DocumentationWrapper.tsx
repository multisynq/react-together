...
export function DocumentationWrapper() {
  return (
    <main className='flex justify-center items-start gap-8 p-6 px-4 sm:px-8 md:px-12 relative bg-[radial-gradient(162.17%_100%_at_100%_0%,#f3f7fd_0%,#f3f7fd_23%,#FFF_100%)]'>
