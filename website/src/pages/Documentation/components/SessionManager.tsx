    ...
    <GenericDocPage
      ...
      description={
        <>
          ...
          <p>
            You can access the Session Manager by clicking the blue button in the bottom-left corner of each browser. This component
            provides a UI to share or leave your current session or to create a private one. To join a session, you can paste the Join URL
            on the top bar (representing the browser URL bar) and press <CodeSpan text='Enter' />, or click on the arrow icon.
          </p>
