...
const name = '___Together'
const originalName = '___'
...
export function AntDesign___TogetherDemo() {
  return (
    <div className='flex-col place-items-center'>
      <___Together rtKey='datepicker-doc-demo' />
    </div>
  )
}
`,
...
export function AntDesign___TogetherDocumentationPage() {
  const api = (
    <>
      <h5>Params</h5>
  ...
  return <DocumentationPage {...{ content, navItems: GenericDocNav('___Together') }} />
}
